                                            ...
                                            <tr>
                                                ...
                                                <td><Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${item.id}`}>{item.name}</Link>
                                                    <div className="mobile-cart-content row">
                                                        ...
                                                        <div className="col-xs-3">
                                                            <h2 className="td-color">{symbol}{(item.price*item.discount/100)}
                                                        ...
                                                        <div className="col-xs-3">
                                                            <h2 className="td-color">
                                                                ...
                                                                <a href="#" className="cart" onClick={() => this.props.addToCartAndRemoveWishlist(item, 1)}>
                                                ...
                                                <td><h2>{symbol}{(item.price*item.discount/100)}
